...
cat.age = 10                    // { name: 'Frida', type: 'cat', age: 10 }
pets[0].age = 5                 // { name: 'Mika', type: 'dog', age: 5 }
pets[1]['naughty'] = true       // { name: 'Frida', type: 'cat', age: 10, naughty: true }


console.log(pets);
/* [
  { name: 'Mika', type: 'dog', age: 5 },
  { name: 'Frida', type: 'cat', age: 10, naughty: true }
] */
